...
Revision ID: 45bdbee334f0
Revises: 
Create Date: 2024-05-13 12:53:52.816788
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['animal_id'], ['animals.id'], name=op.f('fk_cartItems_animal_id_animals')),
